...
.nes-balloon, .nes-btn, .nes-container.is-rounded, .nes-container.is-rounded.is-dark, .nes-dialog.is-rounded, .nes-dialog.is-rounded.is-dark, .nes-progress, .nes-progress.is-rounded, .nes-table.is-bordered, .nes-table.is-dark.is-bordered, .nes-input,
...
.nes-btn:hover, .nes-btn:focus {
  color: inherit;
  text-decoration: none;
  background-color: #e7e7e7;
}

.nes-btn:hover::after, .nes-btn:focus::after {
...
.nes-btn.is-primary:hover, .nes-btn.is-primary:focus {
  color: inherit;
  text-decoration: none;
  background-color: #108de0;
}

.nes-btn.is-primary:hover::after, .nes-btn.is-primary:focus::after {
...
.nes-btn.is-success:hover, .nes-btn.is-success:focus {
  color: inherit;
  text-decoration: none;
  background-color: #76c442;
}

.nes-btn.is-success:hover::after, .nes-btn.is-success:focus::after {
...
.nes-btn.is-warning:hover, .nes-btn.is-warning:focus {
  color: inherit;
  text-decoration: none;
  background-color: #f2c409;
}

.nes-btn.is-warning:hover::after, .nes-btn.is-warning:focus::after {
...
.nes-btn.is-error:hover, .nes-btn.is-error:focus {
  color: inherit;
  text-decoration: none;
  background-color: #ce372b;
}

.nes-btn.is-error:hover::after, .nes-btn.is-error:focus::after {
